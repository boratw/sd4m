...
class Skill_Follower:
    def __init__(self, state_len, action_len, name="",
        ...
        with tf.variable_scope(self.name): 
            self.input_state_noxy = tf.placeholder(tf.float32, [None, state_len - 2], name="input_state_noxy")
            self.input_next_state_noxy = tf.placeholder(tf.float32, [None, state_len - 2], name="input_next_state_noxy")
            self.input_goal = tf.placeholder(tf.float32, [None, 2], name="input_goal")
