...
def Main(args):
    ...
    with sess.as_default():
        ...
        follower_saver.restore(sess, "logs/trpo_hopper_epopt/2022-06-11_16-09-45_log1_follower_4000.ckpt")
        ...
        for mass_it in range(21):
            ...
            for batch in range(10):
                ...
                for step in range(horizon):
                    actions = follower.get_action_batch(states, goals[batch], record=False)
                    new_states = []
                    reward_set = []
                    for i in range(env_num):
